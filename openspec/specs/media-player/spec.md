...
## Purpose
Media panel for playing audio sources (radio, Spotify, local files, podcast episodes) with transport controls adapted to source capabilities, favorites management, and a quick-controls overlay.
